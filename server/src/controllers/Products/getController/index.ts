...
const Unit = async (req: Request, res: Response) =>{
    try {
        ...
        //     ]
        // } as any;
        const response = await ProductsModel.findDocByQuery({query, query2});
        // const response = await ProductsModel.findDocByQuery(combinedQuery);
